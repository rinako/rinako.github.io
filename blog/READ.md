...
<p>
  ...
  如果需要注释<br/><br/> //就这么写，明面上谁都看不到。不要在注释后面加代码。
  就像在AO3那样。<br/>
  ...
  二级文件夹以<strong>【编号_事件】</strong>命名，考虑到一些事件需长期追踪进展，就不标年份了。在该目录下创建<strong>【diary.nss】</strong>用以持续更新事件进展或对事件的思考。创建【info.nss】用以整理涉事人员信息。<br/> //nss文件是汉化DMMd时
